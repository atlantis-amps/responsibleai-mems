...
An LLM: 
- Is a static file containing trained data weights.
- Only knows information up to their training date.
- Has no native Web access, it cannot open a browser or ping a server
